...
.addValidation('#cardHolder', 'name','Sir, your first name must have more than 1 character!')
.addValidation('#cardNumber', 'card','A valid card number must be 16 characters long!')
.addValidation('#csv', 'csv','Your CSV number must be 3 characters long!');
